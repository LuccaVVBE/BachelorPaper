...
\title{Onderzoek naar vermindering van energie verbruik binnen softwareontwikkeling}
\subtitle{Onderzoek naar ontwikkelarchitecturen}
\author{Lucca Van Veerdeghem}
\email{lucca.vanveerdeghem@student.hogent.be}
\supervisor{Lieven Smits}
\cosupervisor{Huzeyfe Kaymak (Davo Group NV)}

% Indien ingevuld, wordt deze informatie toegevoegd aan het einde van de
% abstract. Zet in commentaar als je dit niet wilt.
\specialisation{Mobile \& Enterprise Development}
\keywords{Ontwikkelarchitecturen, energieverbruik, duurzaam, microservices, monoliet}
\projectrepo{https://github.com/LuccaVanVeerdeghem https://github.com/LuccaVanVeerdeghem/BachelorPOC}
