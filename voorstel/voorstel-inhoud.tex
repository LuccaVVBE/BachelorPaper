...
De onderzoeksvraag van deze paper is welke verbetering in performantie ontstaat wanneer er gebruik gemaakt wordt van een microservice-architectuur ten opzichte van een monolithische applicatie. Performantie wordt hier als volgt gedefinieerd: gemiddeld netwerk responstijd, CPU-gebruik, RAM-gebruik en de capaciteit van requests binnen een bepaalde tijdsspanne. 

Volgende doelstellingen dragen bij om een concreet antwoord te voorzien op de onderzoeksvraag:

\begin{itemize}
    \item Literatuurstudie: Gekende mogelijkheden en uitdagingen van monolithische; applicaties en  microservices in kaart brengen;
    \item POC: Een applicatie uitgewerkt als monoliet en een als microservice;
    \item Analyse: De ondervindingen bij de PoC analyseren en hiervan een resultaat vormen.
\end{itemize}
...
\subsection{Performantie binnen softwareontwikkeling}
